  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: bg.bg, color: bg.text }}>
      ...
      <div style={{ flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column', background: bg.bg }}>
        ...
        {/* Content */}
        <div ref={mainRef} data-scroll="true" style={{ flex: 1, overflow: 'auto', padding: '24px' }}
          onScroll={e => { if (showSettings) scrollPosRef.current = e.currentTarget.scrollTop }}>
          ...
          {/* Settings — always mounted, shown/hidden via display to prevent remount on state change */}
          ...
          {/* Tab content — only shown when settings is closed */}
          {!showSettings && (
