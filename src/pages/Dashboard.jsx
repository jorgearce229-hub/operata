      ...
      <div style={{ flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column', background: bg.bg }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '8px', padding: '12px 24px', borderBottom: `1px solid ${bg.border}`, background: bg.card, flexShrink: 0 }}>
          ...
          <button onClick={() => setShowSettings(!showSettings)} style={{
            padding: '7px 14px', borderRadius: '8px', border: `1px solid ${showSettings ? bg.accent : bg.border}`,
            background: showSettings ? bg.accentBg : 'transparent', color: showSettings ? bg.accent : bg.muted,
            fontWeight: 600, fontSize: '13px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px'
          }}>⚙️ {sidebarOpen ? 'Configuración' : ''}</button>
        </div>
