    ...
    <div style={{ minHeight: '100vh', background: C.bg, color: C.text, padding: '40px 20px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <Section title="4. Planes y pagos">
          ...
          <br/>
          <p><b>Plan Pro:</b> $139 MXN/mes o $1,049 MXN/año. Incluye operaciones ilimitadas, analytics avanzados, importación/exportación CSV y todas las funciones Premium.</p>
          <br/>
