...
function CancelSubscription({ subscriptionId, onCancelled, profile, userId }) {
    ...
    <div style={{ maxWidth: '700px', margin: '0 auto', padding: '24px' }} ref={containerRef}>
      ...
      <Section title="Cuenta">
        ...
        {profile?.plan === 'pro' && profile?.stripe_subscription_id && (
          <CancelSubscription subscriptionId={profile.stripe_subscription_id} onCancelled={onProfileUpdate} profile={profile} userId={userId} />
        )}
      </Section>
    </div>
    </div>
