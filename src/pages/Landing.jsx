...
const PLANS = [
  ...
  { name: 'Pro Mensual', price: '$7.99', period: '/mes', features: ['Operaciones ilimitadas', 'Analytics completos', 'Calendar heatmap', 'Backtesting avanzado', 'Importar / Exportar CSV', 'P&L mensual detallado'], cta: 'Empezar Pro', highlight: false },
  { name: 'Pro Anual', price: '$59.99', period: '/año', badge: '🔥 MEJOR VALOR', note: 'Equivale a $5/mes · Ahorras 37%', features: ['Todo lo del plan mensual', 'Acceso prioritario a nuevas funciones'], cta: 'Empezar Pro Anual', highlight: true },
]
