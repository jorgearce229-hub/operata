...
export default function App() {
  ...
  return <Dashboard session={session} profile={profile} onProfileUpdate={handleProfileUpdate} theme={theme} onThemeChange={(mode) => setThemeState(mode)} onShowSettings={() => setShowSettings(true)} />
}
