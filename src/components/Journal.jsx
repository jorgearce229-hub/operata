    ...
    <div>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
        ...
        <div style={{ display:'flex', gap:'8px', alignItems:'center' }}>
          ...
          <button style={{...btn('ghost'),fontSize:'13px'}} onClick={()=>{setShowImport(!showImport);setShowForm(false)}}>
      ...
      {showImport && <ImportTrades userId={userId} onImported={() => { setShowImport(false); onUpdate() }} />}
      {showForm && canAdd && (
