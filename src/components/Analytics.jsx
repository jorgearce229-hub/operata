...
export default function Analytics({ trades, isPro, profile, onUpgrade }) {
  ...
  const capital = parseFloat(profile?.initial_capital) || 0
  ...
  return (
    <div>
      ...
      {isPro
        ? <CalendarHeatmap trades={sorted}/>
        : <ProBlock title="Calendar Heatmap"/>
      }
